        ...
        <div class="product-container__top">
            <div class="product-container__top-img">
                ...
                <div class="product-container__top-form">
                    ...
                    <input class="product-container__input" type="text" name="name" id="name" value="{{ old('name', $product->name) }}">
                    @if($errors->has('name'))
                        <p class="error-massage">{{ $errors->first('name') }}</p>
                    @endif
                    <label  class="product-container__label" for="price">値段</label>
                    <input  class="product-container__input" type="number" name="price" id="price" value="{{ old('price', $product->price) }}">
                    @if($errors->has('price'))
            ...
            <div class="product-container__description">
                ...
                <textarea  class="product-container__description-textarea" name="description" id="description" rows="3">{{ old('description', $product->description) }}</textarea>
